...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  void initState() {
    ...
    _model.nomeFocusNode!.addListener(() => safeSetState(() {}));
                                                                  ...
                                                                  recognizer:
                                                                      TapGestureRecognizer()
                                                                        ..onTap =
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'REGISTER_RichTextSpan_bwli05nl_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'RichTextSpan_launch_u_r_l');
                                                                          await launchURL(
                                                                              'https://blubem.com.br/termos');
                                                                        },
                                                                ),
                                                                TextSpan(
                                                                  text:
                                                    ...
                                                    TextSpan(
                                                      ...
                                                      recognizer:
                                                          TapGestureRecognizer()
                                                            ..onTap = () async {
                                                              logFirebaseEvent(
                                                                  'REGISTER_RichTextSpan_tw7op98f_ON_TAP');
                                                              logFirebaseEvent(
