...
class _CreateSiteEtapas12WidgetState extends State<CreateSiteEtapas12Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {});
      logFirebaseEvent('CreateSiteEtapas12_backend_call');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CREATE_SITE_ETAPAS12_Text_diytjtpb_ON_TA');
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                return InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'CREATE_SITE_ETAPAS12_Row_6dcsu6ze_ON_TAP');
                                                    logFirebaseEvent(
                                              ...
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  onChanged: (_) =>
                                                    ...
                                                    () async {
                                                      logFirebaseEvent(
                                                          'CREATE_SITE_ETAPAS12_TextField_2dynumvf_');
                                                      logFirebaseEvent(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'CREATE_SITE_ETAPAS12_AVANAR_BTN_ON_TAP');
