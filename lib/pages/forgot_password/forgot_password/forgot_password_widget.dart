                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'FORGOT_PASSWORD_RECUPERAR_SENHA_BTN_ON_T');
                                              logFirebaseEvent(
                                              ...
                                              if ((_model.apiResult68d
                                                ...
                                                FFAppState()
                                                        .forgotPasswordWhats =
                                                    functions.clearMaskPhone(_model
                                                        .cellphoneTextController
                                                        .text)!;
                                                safeSetState(() {});
                                                logFirebaseEvent(
                                                ...
                                                TextSpan(
                                                  ...
                                                  recognizer:
                                                      TapGestureRecognizer()
                                                        ..onTap = () async {
                                                          logFirebaseEvent(
                                                              'FORGOT_PASSWORD_RichTextSpan_s9hz82c4_ON');
                                                          logFirebaseEvent(
