...
class _ForgotPassword2WidgetState extends State<ForgotPassword2Widget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ForgotPassword2'});
    // On page load action.
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'FORGOT_PASSWORD2_PAGE_AVANAR_BTN_ON_TAP');
                                              logFirebaseEvent(
                                              ...
                                              if ((_model.apiResult0ni
                                                      ?.succeeded ??
                                                  true)) {
                                                logFirebaseEvent(
                                                    'Button_update_app_state');
                                                FFAppState().forgotPasswordId =
                                                    getJsonField(
                                                  (_model.apiResult0ni
                                                          ?.jsonBody ??
                                                      ''),
                                                  ...
                                                  TextSpan(
                                                    ...
                                                    recognizer:
                                                        TapGestureRecognizer()
                                                          ..onTap = () async {
                                                            logFirebaseEvent(
                                                                'FORGOT_PASSWORD2_RichTextSpan_g59diyw8_O');
                                                            logFirebaseEvent(
                                                                'RichTextSpan_backend_call');
                                                            _model.apiResultupp =
                                                                await APIOficialGroup
                                                                    .forgotPasswordCall
                                                                    .call(
