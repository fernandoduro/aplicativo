...
class CreateSiteEtapa9Widget extends StatefulWidget {
  const CreateSiteEtapa9Widget({super.key});

  @override
  State<CreateSiteEtapa9Widget> createState() => _CreateSiteEtapa9WidgetState();
}

class _CreateSiteEtapa9WidgetState extends State<CreateSiteEtapa9Widget> {
  late CreateSiteEtapa9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateSiteEtapa9Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CreateSiteEtapa9'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (getJsonField(
          ...
          null) {
        logFirebaseEvent('CreateSiteEtapa9_backend_call');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CREATE_SITE_ETAPA9_Text_aambeuqa_ON_TAP');
                                        ...
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            ...
                                            onChanged: (_) =>
                                              ...
                                              () async {
                                                logFirebaseEvent(
                                                    'CREATE_SITE_ETAPA9_busca_ON_TEXTFIELD_CH');
                                                logFirebaseEvent(
                                                    ...
                                                    child: Theme(
                                                      ...
                                                      child: Checkbox(
                                                        ...
                                                        onChanged:
                                                          ...
                                                          if (newValue!) {
                                                            logFirebaseEvent(
                                                                'CREATE_SITE_ETAPA9_Checkbox_f8y66n3l_ON_');
                                                            logFirebaseEvent(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'CREATE_SITE_ETAPA9_AVANAR_BTN_ON_TAP');
                                              logFirebaseEvent(
                                                  'Button_backend_call');
