...
class _CreateSiteEtapa6WidgetState extends State<CreateSiteEtapa6Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('CreateSiteEtapa6_update_page_state');
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final createSiteEtapa6LayoutsResponse = snapshot.data!;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'CREATE_SITE_ETAPA6_Text_fobt8y3d_ON_TAP');
                                            logFirebaseEvent(
                                                'Text_navigate_back');
                                            context.safePop();
                                          },
                                              ...
                                              children: [
                                                Builder(
                                                  builder: (context) {
                                                    final layouts =
                                                        getJsonField(
                                                      createSiteEtapa6LayoutsResponse
                                                          .jsonBody,
                                                      r'''$.data''',
                                                    ).toList();
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'CREATE_SITE_ETAPA6_Image_f5al6pko_ON_TAP');
                                                                    if (_model
                                                                            .imageSelected ==
                                                                        getJsonField(
                                                                          layoutsItem,
                                              ...
                                              FFButtonWidget(
                                                onPressed:
                                                    (_model.imageSelected ==
                                                        ...
                                                        : () async {
                                                            logFirebaseEvent(
                                                                'CREATE_SITE_ETAPA6_ESCOLHER_ESSA_IMAGEM_');
                                                            logFirebaseEvent(
                                                                'Button_backend_call');
