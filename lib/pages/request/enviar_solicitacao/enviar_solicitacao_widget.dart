                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'ENVIAR_SOLICITACAO_RichText_idv4uyjb_ON_');
                                                              logFirebaseEvent(
                                                                  'RichText_store_media_for_upload');
                                                              final selectedMedia =
                                                              ...
                                                              _model.addToImagesToUpload(
                                                                  _model
                                                                      .uploadedLocalFile);
                                                              _model.addToImages64(
                                                                  _model
                                                                      .updatedImage!);
                                                              safeSetState(
                                                                  () {});
                                                              ...
                                                              children: [
                                                                FFButtonWidget(
                                                                  onPressed: _model
                                                                      ...
                                                                      : () async {
                                                                          logFirebaseEvent(
                                                                              'ENVIAR_SOLICITACAO_INICIAR_BTN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                ...
                                                                FFButtonWidget(
                                                                  onPressed: !_model
                                                                      ...
                                                                      : () async {
                                                                          logFirebaseEvent(
                                                                              'ENVIAR_SOLICITACAO_PAGE_PARAR_BTN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          _model.base64Sound =
                                                                              await actions.convertAudioPathToBase64(
                                                    ...
                                                    FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'ENVIAR_SOLICITACAO_ENVIAR_SOLICITAO_BTN_');
                                                        logFirebaseEvent(
                                                            'Button_backend_call');
                                                        _model.resultPostSolicitacao =
                                                            await APIOficialGroup
                                                                .postSolicitacoesCall
                                                                .call(
                                                          authToken:
                                                              currentAuthenticationToken,
                                                          title:
                                                              'Solicitação (${widget.areaName})',
                                                          description: _model
                                                              .textController
                                                              .text,
                                                          audioFile: _model
