...
class _CreateSiteEtapas15WidgetState extends State<CreateSiteEtapas15Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('CreateSiteEtapas15_update_page_state');
      _model.domainsSelected = getJsonField(
        FFAppState().dataSite,
        r'''$.domain''',
      );
      setState(() {});
      logFirebaseEvent('CreateSiteEtapas15_backend_call');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'CREATE_SITE_ETAPAS15_Text_diytjtpb_ON_TA');
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                return InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'CREATE_SITE_ETAPAS15_Row_6dcsu6ze_ON_TAP');
                                                    logFirebaseEvent(
                                              ...
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  onChanged: (_) =>
                                                    ...
                                                    () async {
                                                      logFirebaseEvent(
                                                          'CREATE_SITE_ETAPAS15_TextField_2dynumvf_');
                                                      logFirebaseEvent(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'CREATE_SITE_ETAPAS15_FINALIZAR_BTN_ON_TA');
