...
class _CreateSiteEtapa1WidgetState extends State<CreateSiteEtapa1Widget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('CreateSiteEtapa1_custom_action');
      await actions.lockOrientation();
      logFirebaseEvent('CreateSiteEtapa1_update_app_state');
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              'Criar seu site nunca foi tão fácil, sabia?',
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'A seguir farei algumas perguntas sobre seus atendimentos, sua especialidade, e algumas preferências…',
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'Com suas respostas vou gerar sua página online, que você poderá compartilhar em redes sociais ou enviar para possíveis pessoas interessadas em conhecer mais do seu trabalho.',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
                                                  ...
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'CREATE_SITE_ETAPA1_VAMOS_L_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_navigate_to');
