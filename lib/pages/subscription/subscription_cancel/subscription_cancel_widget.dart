...
class SubscriptionCancelWidget extends StatefulWidget {
  const SubscriptionCancelWidget({super.key});

  @override
  State<SubscriptionCancelWidget> createState() =>
      _SubscriptionCancelWidgetState();
}

class _SubscriptionCancelWidgetState extends State<SubscriptionCancelWidget> {
  late SubscriptionCancelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubscriptionCancelModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SubscriptionCancel'});
    // On page load action.
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'SUBSCRIPTION_CANCEL_CANCELAR_PLANO_BTN_O');
                                          logFirebaseEvent(
                                              'Button_backend_call');
                                          _model.apiResultfsx =
