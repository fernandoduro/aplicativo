                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              InkWell(
                                                                                ...
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('RATINGS_PAGE_Text_d3h3uqh9_ON_TAP');
                                                                                            ...
                                                                                            child: FFButtonWidget(
                                                                                              onPressed: () {
                                                                                                if (_model.isRecording) {
                                                                                                  ...
                                                                                                  ? null
                                                                                                  : () async {
                                                                                                      logFirebaseEvent('RATINGS_PAGE_SALVAR_AVALIAO_BTN_ON_TAP');
                                                                                                      if (_model.idRating == null) {
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        FutureBuilder<ApiCallResponse>(
                                                                                          ...
                                                                                          builder: (context, snapshot) {
                                                                                            ...
                                                                                            final columnListRatingsResponse = snapshot.data!;
