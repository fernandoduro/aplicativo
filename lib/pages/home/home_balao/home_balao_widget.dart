                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    5.0, 0.0, 5.0, 0.0),
                                            child: Text(
                                              'Sou uma assistente digital que está nascendo para cuidar das coisas que você não deveria gastar tanto tempo, já que sua dedicação já é cuidar de tanta gente.',
                                              style:
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    5.0, 0.0, 5.0, 0.0),
                                            child: Text(
                                              'Quero simplificar sua rotina de atendimento e te apoiar na sua jornada profissional.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
