              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.siteResult =
                                            await APIOficialGroup.getSiteCall
                                                .call(
                                        ...
                                        if (getJsonField(
                                          ...
                                          context.pushNamed('CreateSiteEtapa0');
                                        }

                                        setState(() {});
                                      },
                                      text: !FFAppState().existSite
                                          ? 'Criar gratuitamente'
                                          : 'Edite seu site',
                                                ...
                                                Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          5.0, 0.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Sites são a forma mais eficaz de gerar e administrar sua carteira de clientes.',
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 11.0),
                      child: Container(
                        decoration: BoxDecoration(
                          color: FlutterFlowTheme.of(context).primary,
                          boxShadow: const [
