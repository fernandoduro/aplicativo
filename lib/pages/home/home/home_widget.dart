  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().historySite = getJsonField(
        (_model.apiResultView?.jsonBody ?? ''),
        r'''$.data''',
      );
      safeSetState(() {});
      if (FFAppState().existPlan == false) {
        logFirebaseEvent('Home_backend_call');
        _model.apiResultGetUserHome = await APIOficialGroup.getUserCall.call(
          authToken: currentAuthenticationToken,
        );

        if (functions.existElementList(getJsonField(
              (_model.apiResultGetUserHome?.jsonBody ?? ''),
              r'''$.features''',
              true,
            )) ==
            true) {
          logFirebaseEvent('Home_update_app_state');
          FFAppState().existPlan = true;
          safeSetState(() {});
        } else {
          logFirebaseEvent('Home_update_app_state');
          FFAppState().existPlan = false;
          safeSetState(() {});
        }
      }
    });
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'HOME_PAGE_Button_bhuva68e_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Button_action_block');
                                                              await action_blocks
                                                                  .seuSite(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'HOME_PAGE_Button_uqmkr40n_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_backend_call');
                                                            _model.siteResult2 =
                            ...
                            if ((FFAppState().existSite == true) && loggedIn)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    20.0, 12.0, 20.0, 0.0),
                                child: Container(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'HOME_PAGE_VER_AGENDA_BTN_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Button_action_block');
                                                              await action_blocks
                                                                  .agenda(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'HOME_PAGE_VER_CLIENTES_BTN_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Button_action_block');
                                                              await action_blocks
                                                                  .meusClientes(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'HOME_PAGE_INCLUIR_NOVO_BTN_ON_TAP');
                                                            var _shouldSetState =
                                                                false;
                                                            logFirebaseEvent(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'HOME_PAGE_ENVIAR_SOLICITAO_BTN_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Button_action_block');
                                                              await action_blocks
                                                                  .assistente(
