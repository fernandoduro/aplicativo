...
class NewClient04Widget extends StatefulWidget {
  const NewClient04Widget({
    super.key,
  ...
  @override
  State<NewClient04Widget> createState() => _NewClient04WidgetState();
}

class _NewClient04WidgetState extends State<NewClient04Widget> {
  late NewClient04Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewClient04Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'NewClient04'});
    // On page load action.
                                                    ...
                                                    Column(
                                                      ...
                                                      children: [
                                                        FFButtonWidget(
                                                          onPressed: () async {
                                                            logFirebaseEvent(
                                                                'NEW_CLIENT04_PAGE_EDITAR_BTN_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Button_navigate_to');
                                                            ...
                                                            Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'NEW_CLIENT04_PAGE_ATUALIZAR_BTN_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Button_backend_call');
