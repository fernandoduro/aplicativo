...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    blubemAuthUserSubject.add(
      BlubemAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BlubemAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BlubemAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BlubemAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    blubemAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
